...
export const MapWorkspace: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // 1. Basemaps (Google Híbrido, Google Satélite Puro, Esri World Imagery & OpenStreetMap)
    ...
    const googleSatellite = new TileLayer({
      source: new XYZ({
        ...
        attributions: '&copy; Google Satellite HD',
        maxZoom: 20,
        crossOrigin: 'anonymous',
      }),
      visible: activeBasemap === 'google-satellite',
    });
    ...
    const map = new Map({
      ...
      layers: [googleHybrid, googleSatellite, esriSatellite, osm],
